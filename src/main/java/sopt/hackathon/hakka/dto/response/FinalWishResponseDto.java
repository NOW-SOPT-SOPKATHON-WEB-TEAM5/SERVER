...
public record FinalWishResponseDto(Long wishId, Long questionId, String content) {
    ...
    public static FinalWishResponseDto of (FinalWish finalWish){
        return new FinalWishResponseDto(finalWish.getWish().getWishId(), finalWish.getWish().getQuestion().getQuestionId(),finalWish.getWish().getContent());
    }
}
